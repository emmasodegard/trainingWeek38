...
let daysUntilMyBirthday = 35;
let millimetersOfRainfall; 4;
...
*/
console.log("Task: B");
const secondsIn2_5Hours = 2.5 * minutesInOneHour * secondsInOneMinute;
console.log(secondsIn2_5Hours);

const minutesIn123Days = 123 * hoursInADay * minutesInOneHour;
